...
# Get field metadata
field_info = get_field_info(cell_seg_path)
if(is.null(field_info))
  stop('Spatial distribution report requires a matching component data',
       ' or segmentation map file.')
...
window = spatstat::owin(xrange=xlim, yrange=ylim)
