...
vignette. `from_with` is the number of `CD68+` cells having at least 
one `CK+` cell within 25 &mu;m. `within_mean` is the average number of
`CK+` cells found within 25 &mu;m of each `CD68+` cell.
...
with a `CD8+` or `CK+` within 10 or 25 &mu;m, 
