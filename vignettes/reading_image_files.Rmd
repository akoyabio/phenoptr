...
dimensions and converted to microns when read by `informr::read_cell_seg_data`.
...
The [`RBioFormats`](https://github.com/aoles/RBioFormats) package may
be an alternative for reading larger component data files.
...
See the next section for examples of displaying grayscale images.
